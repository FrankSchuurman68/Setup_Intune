...
{
    "description": "Dit beleid beveiligd applicatie data op een MDM beheerd Windows 10 apparaat",
    "displayName": "Portall - Windows 10 Beheerd Apparaat Applicatie Beveiliging Level 1",
